...
export function Create() {
  ...
  const {isPending, mutateAsync: creatCustomer} = useMutation({ mutationFn: async (data: DataMutation) => {
  ...
  return (
    <div className="flex-1 flex flex-col py-12 px-10 gap-8 overflow-y-auto">
      <section className="flex flex-1 flex-col items-center">
        <h1 className="text-white font-semibold text-xl lg:text-3xl ">Cadastro novo cliente</h1>
